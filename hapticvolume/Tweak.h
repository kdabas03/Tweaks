...
#define kIdentifier @"com.cheaterstar.hapticvolprefs"
#define kSettingsChangedNotification (CFStringRef)@"com.cheaterstar.hapticvolprefs/reload"
#define kSettingsPath @"/var/mobile/Library/Preferences/com.cheaterstar.hapticvolprefs.plist"
...
// Add later:  legacyVibrationEnabled = boolValueForKey(@"legacyVibrationEnabled", NO);
}
